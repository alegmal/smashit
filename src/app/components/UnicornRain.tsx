...
const EMOJIS = ['🦄', '🌈', '✨'];
const TOTAL_DESKTOP = 750;
const TOTAL_MOBILE = 150;
const BATCH = 40;
...
export const UnicornRain = React.memo(function UnicornRain({ visible, isMobile = false }: Props) {
        ...
        <>
            {visible && (
                <div
                    ...
                    style={{
                        background: 'linear-gradient(135deg, #ff6b9d, #ffd700, #2ed573, #1e90ff, #a29bfe)',
                        animation: 'rainbow-sweep 4s ease-in-out forwards',
                        opacity: 0.3,
                    }}
                />
            )}
